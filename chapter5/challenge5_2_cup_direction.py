...
class CupDirection(Node):
  """
  Create a CupDirection class, which is a subclass of the Node class.
  """
  def __init__(self):
    """
    ...
    super().__init__('challenge5_2_cup_direction')
...
def main(args=None):
  ...
  # Create the node
  challenge5_2_cup_direction = CupDirection()
  
  # Spin the node so the callback function is called.
  rclpy.spin(challenge5_2_cup_direction)
  
  # Destroy the node explicitly
  # (optional - otherwise it will be done automatically
  # when the garbage collector destroys the node object)
  challenge5_2_cup_direction.destroy_node()
